...
class ToolsController extends Controller
{
    ...
    public function sslchecker($lang)
    {
        ...
        return view('Tools/sslchecker', compact('local', 'is_maintenance'));
    }
    ...
    public function jsonld($lang)
    {
        ...
        // $dataEN = $this->HomeController->getBlogWordpressEn();
        $local = App::getLocale();
        return view('jsonldhome', compact('local'));
    }
    ...
    public function FAQ($lang)
    {
        ...
        return view('Tools/faq', compact('local', 'is_maintenance'));
    }
    ...
    public function breadcrumb($lang)
    {
        ...
        return view('Tools/breadcrumb', compact('local', 'is_maintenance'));
    }
    ...
    public function howto($lang)
    {
        ...
        // currencies
        $path_currencies = public_path('js/app/json/currencies.json');
        ...
        return view('Tools/howto', compact('local', 'currencies', 'is_maintenance'));
    }
    ...
    public function jobposting($lang)
    {
        ...
        // country
        $path = public_path('js/app/json/regions.json');
        $region = json_decode(file_get_contents($path), true);

        // province
        $path_province = public_path('js/app/json/province-id.json');
        ...
        return view('Tools/jobPosting', compact('local', 'region', 'province', 'currencies', 'is_maintenance'));
    }
    ...
    public function person($lang)
    {
        ...
        return view('Tools/person', compact('local', 'is_maintenance'));
    }
    ...
    public function product($lang)
    {
        ...
        return view('Tools/product', compact('local', 'currencies', 'is_maintenance'));
    }
    ...
    public function recipe($lang)
    {
        ...
        return view('Tools/recipe', compact('local', 'is_maintenance'));
    }
    ...
    public function wordcounter($lang)
    {
        ...
        return view('Tools/wordcounter', compact('local', 'is_maintenance'));
    }
    ...
    public function metachecker($lang)
    {
        ...
        return view('Tools/metachecker', compact('local', 'is_maintenance'));
    }
    ...
    public function pagespeed($lang)
    {
        ...
        return view('Tools/pagespeed', compact('local', 'is_maintenance'));
    }
    ...
    //   $dataEN = $this->HomeController->getBlogWordpressEn();
      ...
      return view('Tools/mobiletest', compact('local', 'is_maintenance'));
    }
    ...
    //   $dataEN = $this->HomeController->getBlogWordpressEn();
      ...
      return view('Tools/sitemap', compact('local', 'is_maintenance'));
    }
    ...
    public function robotgenerator($lang)
    {
        ...
        return view('Tools/robotgenerator', compact('local', 'is_maintenance'));
    }
...
//        $dataEN = $this->HomeController->getBlogWordpressEn();
        ...
        return view('Tools/technologylookup', compact('local', 'is_maintenance'));
    }
    ...
    public function redirectchecker($lang)
    {
        ...
        return view('Tools/redirectchecker', compact('local', 'is_maintenance'));
    }
    ...
    public function hreflangchecker($lang)
    {
        ...
        return view('Tools/hreflangchecker', compact('local', 'is_maintenance'));
    }
    ...
    public function linkanalyzer($lang)
    {
        ...
        return view('Tools/linkanalyzer', compact('local', 'is_maintenance'));
    }
    ...
    public function keywordresearch($lang)
    {
        ...
        return view('Tools/keywordresearch', compact('local', 'is_maintenance'));
    }
    ...
    public function keywordpermutation($lang)
    {
        ...
        return view('Tools/keywordpermutation', compact('local', 'is_maintenance'));
    }
